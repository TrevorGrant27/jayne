        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="reveal-stagger space-y-12">
            <div className="border-t border-[#e5e0d8] pt-8">
              ...
              <p className="text-xl text-[#8a8178] font-[family-name:var(--font-open-sans)]">Surveys and interviews to prove out the brand platform and identify critical gaps that went undetected in standardized testing.</p>
            </div>

            <div className="border-t border-[#e5e0d8] pt-8">
              <p className="text-5xl md:text-6xl text-[#f57214] mb-4">02</p>
              <h3 className="text-2xl md:text-3xl text-[#1a1a1a] mb-3">Diversity nuances</h3>
              <p className="text-xl text-[#8a8178] font-[family-name:var(--font-open-sans)]">Identify 3 critical gaps related to the crucial nuances of visible and invisible diversity—factors standard testing couldn&apos;t capture.</p>
            </div>
            ...
            <div className="border-t border-b border-[#e5e0d8] pt-8 pb-8">
              ...
              <p className="text-xl text-[#8a8178] font-[family-name:var(--font-open-sans)]">Develop critical insights and strategic imperatives that could serve as a foothold—not just for Preparedness, but for the whole American Red Cross brand.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="reveal-stagger grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-lg text-[#8a8178] font-[family-name:var(--font-open-sans)]">critical gaps identified</p>
            </div>
            <div>
              <div className="text-4xl md:text-5xl text-[#f57214] mb-2">Global</div>
              <p className="text-lg text-[#8a8178] font-[family-name:var(--font-open-sans)]">brand impact potential</p>
            </div>
          </div>
        </div>
      </section>
