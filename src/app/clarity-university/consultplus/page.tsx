...
const cohorts = [
  {
    ...
    weeks: [
      ...
      { week: 2, date: "Monday, January 13, 2025", time: "11:00am – 1:30pm CT", title: "2.5 Hours Brand Strategy Consulting" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, date: "Monday, February 10, 2025", time: "11:00am – 1:30pm CT", title: "2.5 Hours Brand Strategy Consulting" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, date: "Monday, April 14, 2025", time: "11:00am – 1:30pm CT", title: "2.5 Hours Brand Strategy Consulting" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, date: "Monday, June 9, 2025", time: "11:00am – 1:30pm CT", title: "2.5 Hours Brand Strategy Consulting" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, date: "Monday, July 14, 2025", time: "11:00am – 1:30pm CT", title: "2.5 Hours Brand Strategy Consulting" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, date: "Monday, August 11, 2025", time: "11:00am – 1:30pm CT", title: "2.5 Hours Brand Strategy Consulting" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, date: "Monday, September 15, 2025", time: "11:00am – 1:30pm CT", title: "2.5 Hours Brand Strategy Consulting" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, date: "Monday, October 13, 2025", time: "11:00am – 1:30pm CT", title: "2.5 Hours Brand Strategy Consulting" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, date: "Monday, November 10, 2025", time: "11:00am – 1:30pm CT", title: "2.5 Hours Brand Strategy Consulting" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, date: "Monday, December 8, 2025", time: "11:00am – 1:30pm CT", title: "2.5 Hours Brand Strategy Consulting" },
...
export default function ConsultPlusRegistration() {
  useScrollReveal();
      ...
      <section className="pt-32 pb-16 lg:pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl leading-[1.05] text-[#1a1a1a] opacity-0 animate-fade-in mb-8 tracking-wide">
            ConsultPlus Package Cohort Registration and Payment
          </h1>
          <p className="text-xl md:text-2xl text-[#8a8178] opacity-0 animate-fade-in animation-delay-100 font-[family-name:var(--font-open-sans)] leading-relaxed">
            Our premium option for those who want deep, hands-on brand strategy consulting. Includes 2.5 hours of dedicated brand strategy consulting in Week 2, plus all the benefits of the Plus package. Funds can be applied towards a full team Brand Strategy Session.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 lg:py-32 px-6">
        <div className="max-w-3xl mx-auto">
          <h2 className="reveal text-4xl md:text-5xl text-[#1a1a1a] leading-tight mb-6">
            Not sure if ConsultPlus is right for you?
          </h2>
